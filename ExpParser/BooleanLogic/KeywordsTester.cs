...
namespace ExpParser.BooleanLogic
{
    class KeywordsTester
    {
        ...
        public void test()
        {
            ...
            ExpBaseParser kexp = new KeywordsExpressionParser(kw);
            ...
            kexp = new BooleanLogicExpressionParser(kw, new SQLSemantic(te));
            ...
            BooleanLogicExpressionParser parser = new BooleanLogicExpressionParser("(maria gheorghe) and not (andrew anthony)", new SQLSemantic(te));
